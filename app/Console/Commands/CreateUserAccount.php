...
class CreateUserAccount extends Command
{
    ...
    public function handle()
    {
        ...
        $this->line('Enter the user account details, ');
        ...
        if ($this->confirm('Confirm the creation of the user account?', true)) {
            ...
            try {
                ...
                return $this->info('User account `' . $name . '` created successfully!');
            } catch (\Throwable $th) {
                $this->error($th->getMessage());
            }
        } else {
            $this->error('User account creation canceled!');
        }
    }
}
